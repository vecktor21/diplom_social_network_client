...
const BannedUsersPanel= () => {
    ...
    const fetchBanList = async()=>{
        try{
            ...
            const res = await BanService.GetUserBans(userStore?.user.userId)
            console.log(res)
            setBanList(res)
            ...
            {isLoading
                ...
                <div>
                    ...
                    <div>
                        ...
                        :
                            banList.map(x=>
                                <BannedUserComponent BannedUser={x} key={x.blockedUserId} setIsLoading={setIsLoading} setIsError={setIsError}/>
                            )
                        }
